...
<main class="row">
	<form method="post" action="">
		<div>
			<h1 class="row d-flex justify-content-center mb-5 p-2">Mon
				Profil</h1>
			<div class="p-3">
				...
				<div class="row mb-3">
						...
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group">
									<input class="case" type="text" id="pseudo" name="pseudo"
					...
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group">
									<input class="case" type="text" id="nom" name="nom"
				...
				<div class="row mb-3">
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group">
									<input class="case" type="text" id="prenom" name="prenom"
					...
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group">
									<input class="case" type="email" id="email" name="email"
				...
				<div class="row mb-3">
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group">
									<input class="case" type="text" id="telephone" name="telephone"
					...
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group">
									<input class="case" type="text" id="rue" name="rue"
