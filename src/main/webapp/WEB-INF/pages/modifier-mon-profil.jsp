						...
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="text" name="pseudo" id="pseudo"
				...
				<div class="row mb-3">
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="text" name="telephone"
					...
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="text" name="rue" id="rue"
				...
				<div class="row mb-3">
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="text" name="CP" id="codePostal"
										value="${user.codePostal}" required pattern="[0-9]{5}">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="text" name="ville" id="ville"
										value="${user.ville}" required pattern="^[A-Za-z'- ]{1,30}">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row mb-3">
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="password" name="mdpa"
										id="motPasseActuel" value="${user.motDePasse}">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row mb-3">
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="password" name="nmdp"
										id="nouveauMotPasse">
								</div>
							</div>
						</div>
					...
					<div class="col">
						<div class="row">
							...
							<div class="col-8">
								<div class="input-group input-group-sm mb-3">
									<input class="w-100" type="password" name="cmdp"
		...
		<div class="row mb-3">
			<div class="col d-flex justify-content-center">
				<button type="submit" name="button" class="btn btn-dark"
					value="valider">Enregistrer</button>
			</div>
			<div class="col">
				<div class="col d-flex justify-content-center">
