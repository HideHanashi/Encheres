			...
			<div class="card p-3" style="width: 30rem;">
				<div class="card-body">
					...
					<div class="p-3">
						...
						<input type="text" class="form-control" readonly="readonly" value="${ enchere.articleVendu.retrait.rue }" name="rue" id="rue">
					</div>
					<div class="p-3">
						<label for="codePostal" class="form-label">Code Postal :</label>
						<input type="text" class="form-control" readonly="readonly" value="${ enchere.articleVendu.retrait.codePostal }" name="codePostal" id="codePostal">
					</div>
					<div class="p-3">
						<label for="ville" class="form-label">Ville :</label>
						<input type="text" class="form-control" readonly="readonly" value="${ enchere.articleVendu.retrait.ville }" name="ville" id="ville">
					</div>
				</div>
			</div>
			<div class="p-3">
