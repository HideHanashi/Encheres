	...
	<div class="col">
		...
		<div class="row mt-5">
			<div class="col-4 offset-4">
				...
				<div class="row mt-5">
           			 <div class="mb-3">
              			  <a class="btn btn-secondary" href="${pageContext.request.contextPath}/liste-enchères">Retour</a>
           			 </div>
           			 <c:if test="${displayBtnModif==true}">
                		<div class="mb-3">
							<a class="btn btn-info"href="${ pageContext.request.contextPath }/modifiermonprofil">Modifier</a>
						</div>
            		</c:if>
        		</div>
			</div>
